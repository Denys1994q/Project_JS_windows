...
window.addEventListener('DOMContentLoaded', function () {
  // скріпти починають працювати коли загрузилася верстка
  'use strict';
  ...
  Object(_modules_changeModalState__WEBPACK_IMPORTED_MODULE_4__["default"])(modalState); // ф-ія, яка збирає дані у modalState

  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_1__["default"])(); // не передаємо прямо в основну ф-ію параметри, бо там дві функції різні

  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.glazing_slider', '.glazing_block', '.glazing_content', 'active'); // передаємо прямо сюди, бо лише одна ф-ія

  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.decoration_slider', '.no_click', '.decoration_content > div > div', 'after_click');
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.balcon_icons', '.balcon_icons_img', '.big_img > img', 'do_image_more', 'inline-block');
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_3__["default"])(modalState); // передаємо modalState у forms, щоб додати дані у останню formData

  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])('#timer', '2022-01-20');
...
var changeModalState = function changeModalState(state) {
  ...
  var windowForm = document.querySelectorAll('.balcon_icons_img'),
      ...
      windowProfile = document.querySelectorAll('.checkbox'); // записуємо їх значення
        ...
        switch (item.nodeName) {
          ...
          case 'INPUT':
            if (item.getAttribute('type') === 'checkbox') {
              ...
              // якщо інпут звичайний (висота, ширина)
...
var checkNumInputs = function checkNumInputs(input) {
  var inputNumbers = document.querySelectorAll(input);
  inputNumbers.forEach(function (item) {
...
var forms = function forms(state) {
  var windows = document.querySelectorAll('[data-modal]'); // шукаємо всі форми за тегом 'form'
    ...
    item.addEventListener('submit', function (e) {
      ...
      if (item.getAttribute('data-calc') === 'end') {
        for (var key in state) {
          // додаємо дані з попередніх форм у форму end
...
var timer = function timer(id, deadline) {
  ...
  function getTimeRemaining(endtime) {
    // рахує різницю від кінця акції до нинішнього часу 
    var t = Date.parse(endtime) - Date.parse(new Date()); // показує різницю в мілісекундах 
  ...
  function getZero(num) {
    // робить, щоб виводилося на сторінку як "09"
    if (num >= 0 && num < 10) {
      return "0".concat(num);
    } else {
      return num;
  ...
  function setClock(selector, endtime) {
    // виводить на сторінку цифри з ф-ії getTimeRemaining
    ...
    var timeInterval = setInterval(updateClock, 1000); // кожну секунду виводить ф-ію updateClock

    updateClock();

    function updateClock() {
      // кожну секунду перезаписує innerHTML блоків дні, години тощо
      ...
      if (t.total <= 0) {
        // якщо час менше 0, інтервал зупиняється
